...
words_list = ["data", "marcel", "playstation", "truck"]
...
def print_scaffold(guesses, wd): # prints the stickman
      if (guesses == 0):
            print("_________")
            print("|    |")
            print("|")
        ...
        if len(guess) > 1:
            ...
            if new_blanks_list == blanks_list:
                ...
                if word_list == blanks_list:
                    ...
                    print("You have guessed the word! Guess another word!")
